...
//
// Guarded launcher for the destructive SRAM-loader hardware test. The actual
// test runs under flutter_tester because the shared transport layer includes
// Flutter's Android USB-host implementation as well as desktop libusb.
import 'dart:io';
...
String _usage() =>
    'Usage: dart run tool/swdart_loader_stress.dart '
...
Future<void> main(List<String> args) async {
  ...
  final flutterArgs = <String>[
    'test',
    'test/hardware/swdart_loader_stress_test.dart',
    '--dart-define=X3UTILS_LOADER_STRESS_CONFIRMED=true',
    '--dart-define=X3UTILS_LOADER_STRESS_CYCLES=${options.cycles}',
    if (options.outputDirectory != null)
      '--dart-define=X3UTILS_LOADER_STRESS_OUT=${options.outputDirectory}',
  ];
