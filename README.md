...
- **[GUI v2.1.6 BETA](https://github.com/ztakis/x3utils/releases/tag/gui-v2.1.6-beta)** — latest test build for Windows, Linux and macOS plus an arm64 Android APK for sideloading.
